function About() {
    return (
        <div className="box m-5">
            ...
            <p>Esta aplicación se hace como parte del primer taller de la asignatura Simulación por Computador, de la escuela de Ingeniería de Sistemas y Computación de la
